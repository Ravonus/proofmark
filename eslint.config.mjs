			...
			patterns: [
				{
					...
					message:
						"Premium modules must not be imported via relative paths. Use ~/generated/premium/* bridges for client code, or ~/premium/* (with webpackIgnore + try/catch) for server code.",
				},
			],
		},
	],
