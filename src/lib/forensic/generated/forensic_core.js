...
/**
 * @param {string} tape_base64
 * @returns {any}
 */
export function analyze_replay_signature_activity(tape_base64) {
    const ptr0 = passStringToWasm0(tape_base64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.analyze_replay_signature_activity(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function analyze_signature_strokes(strokes) {
    const ret = wasm.analyze_signature_strokes(strokes);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function build_replay_timeline(tape_base64, lane, label) {
    const ptr0 = passStringToWasm0(tape_base64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(label) ? 0 : passStringToWasm0(label, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.build_replay_timeline(ptr0, len0, lane, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function decode_replay_events(tape_base64) {
    const ptr0 = passStringToWasm0(tape_base64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decode_replay_events(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function encode_replay_events(events) {
    const ret = wasm.encode_replay_events(events);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {string}
 */
export function encode_signature(strokes) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.encode_signature(strokes);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {any}
 */
export function merge_replay_timelines(timelines) {
    const ret = wasm.merge_replay_timelines(timelines);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('forensic_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
