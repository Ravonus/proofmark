...
async function runEmailPostSignSideEffects(params: {
  ctx: any;
  doc: any;
  docSigners: any;
  signer: any;
...
async function prepareEmailSign(ctx: any, input: any, doc: any, docSigners: any, signer: any) {
...
function validateEmailSigner(signer: any, doc: any): asserts signer {
...
async function persistEmailSignature(
  db: any,
  params: {
    signer: any;
    email: string;
