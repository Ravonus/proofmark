...
const NON_REUSABLE_TYPES = new Set(["checkbox", "file", "payment", "idv", "social-verify"]);
const NON_FILL_ALL_TYPES = new Set(["checkbox", "file", "payment", "idv", "social-verify", "signature"]);
