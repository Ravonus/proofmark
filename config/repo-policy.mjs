...
export const structureManifest = [
	...
	},
	{
		path: "contracts",
		optional: true,
		purpose: "Solidity smart contracts, Hardhat config, and Anchor programs.",
		keepHere: ["Smart contract source, tests, deploy scripts, and ABIs."],
		avoidHere: ["TypeScript application logic."],
	},
	{
		path: "premium",
		optional: true,
	...
	},
	{
		...
		purpose: "Billing upgrade banners and payment-related UI.",
		keepHere: ["Upgrade nudges, billing status components."],
		avoidHere: ["Server billing logic."],
	},
	{
	...
	{
		path: "src/components/pdf-viewer",
		purpose: "PDF document viewer and renderer components.",
		keepHere: ["PDF preview and rendering UI."],
		avoidHere: ["PDF parsing or analysis logic."],
	},
	{
	...
	{
		path: "src/server/billing",
		purpose: "Billing gates, Stripe API, usage tracking, and payment orchestration.",
		keepHere: ["Billing enforcement, Stripe wrappers, and usage metering."],
		avoidHere: ["UI components or route definitions."],
	},
	{
