...
Solidity smart contracts, Hardhat config, and Anchor programs.

Keep here:
- Smart contract source, tests, deploy scripts, and ABIs.
...
Billing upgrade banners and payment-related UI.

Keep here:
- Upgrade nudges, billing status components.
...
PDF document viewer and renderer components.

Keep here:
- PDF preview and rendering UI.

Avoid here:
- PDF parsing or analysis logic.
...
Billing gates, Stripe API, usage tracking, and payment orchestration.

Keep here:
- Billing enforcement, Stripe wrappers, and usage metering.

Avoid here:
- UI components or route definitions.
